...
public class ExampleRunner {
	...
	*/
	public static void main(String[] args) {
		...
		System.out.println("Formatting [23000000000] - Result [" + prettifier.format(new Double(23000000000d)) + "]");
		System.out.println("Formatting [31900000.0342] - Result [" + prettifier.format(31900000.0342d) + "]");
		System.out.println("Formatting [47100000000000] - Result [" + prettifier.format(new Double(47100000000000d)) + "]");
